const comunidades = [
  ...
  { nombre: "Asturias", bandera: "../img/n_asturias.png", url: "https://medioambiente.asturias.es/general/-/categories/766392" },
...
comunidades.forEach(region => {
  ...
  a.className = "region-btn";
  a.href = region.url;
  a.target = "_blank";
  a.rel = "noopener";
  a.setAttribute("aria-label", `${region.nombre} (abre en pestaña nueva)`);
  a.innerHTML = `<img src="${region.bandera}" alt="">`;
  li.appendChild(a);
