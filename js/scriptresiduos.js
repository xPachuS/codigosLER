...
function showResiduosPorCategoria(categoria, residuos) {
  ...
  residuosFiltrados.forEach(residuo => {
    const li = document.createElement("li");
    li.classList.add('bg-white', 'p-6', 'rounded-lg', 'shadow-lg', 'hover:shadow-xl', 'transition', 'duration-200', 'cursor-pointer', 'hover:scale-105', 'h-50'); // h-50 es la clase para altura fija (256px)
