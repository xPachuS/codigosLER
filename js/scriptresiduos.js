...
fetch('ler-data.json')
  ...
  .then(data => {
    ...
    categorias.forEach(categoria => {
      ...
      li.classList.add('cursor-pointer', 'text-indigo-600', 'hover:text-indigo-800', 'transition', 'duration-200', 'font-medium', 'text-center', 'rounded-lg', 'hover:bg-indigo-50', 'py-6', 'flex', 'items-center', 'justify-center', 'group', 'shadow-lg', 'hover:shadow-xl', 'h-64');
